    ...
    <div className='w-[60%] mx-auto'>
        ...
        <TableHeader className="w-[700px] h-[40px] boder-b p-2 gap-4">
          <TableRow className='w-full'>
            ...
            <TableHead className='w-[180px] h-[20px] border-l p-2'>Stack</TableHead>
            <TableHead className='w-[180px] h-[20px] border-l p-2'>Employment Type</TableHead>
            <TableHead  className='w-[120px] h-[20px] border-l p-2'>Status</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {data.map((row, idx) => (
            ...
            >
              ...
              <TableCell className='flex items-center justify-end gap-2 h-[40px] border-b border-[#1c1c1c0d]'>
                {row.status}
                <Button
                  variant="ghost"
                  size="icon"
                  className="flex items-center justify-center gap-2 hover:text-[#1c1c1c0d] cursor-pointer"
                >
