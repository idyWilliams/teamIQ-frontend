    ...
    <div className="w-full">
      ...
      {isDialogOpen && (
        ...
        >
          ...
          {/* Modal Content */}
          <div
            className="relative z-10 my-auto max-h-[90vh] w-full max-w-4xl rounded-2xl bg-white shadow-xl"
            ...
            <div className="max-h-[90vh] overflow-y-auto">
              {selectedMember && (
                <div className="p-8">
                  ...
                  <button
                    onClick={handleCloseDialog}
                    className="absolute top-6 right-6 flex h-10 w-10 items-center justify-center rounded-full bg-gray-900 text-white transition-colors hover:bg-gray-800"
                  >
                    <svg
                      className="h-5 w-5"
                      fill="none"
