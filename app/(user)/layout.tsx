...
export default function TeamDashboardLayout({ children }: LayoutProps) {
  ...
  return (
    <div className="flex h-screen">
      ...
      {isOpen && <div className="fixed inset-0 z-30 bg-black/70 lg:hidden" />}
      ...
      {isDashboardRoute ? (
        ...
        <>
          ...
          <Button
            ...
            className="fixed right-4 bottom-4 hidden cursor-pointer rounded-full bg-[#5395dc] p-3 text-white shadow-lg lg:block"
          >
            <Bell size={24} />
          </Button>
          {/* notification modal */}
